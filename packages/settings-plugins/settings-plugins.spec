...
Provides: %{_cross_os}settings-plugin(aws-k8s-1.33-amdgpu)
Provides: %{_cross_os}settings-plugin(aws-k8s-1.33-amdgpu-fips)
Provides: %{_cross_os}settings-plugin(aws-k8s-1.33-fips)
Provides: %{_cross_os}settings-plugin(aws-k8s-1.34)
Provides: %{_cross_os}settings-plugin(aws-k8s-1.34-amdgpu)
Provides: %{_cross_os}settings-plugin(aws-k8s-1.34-amdgpu-fips)
